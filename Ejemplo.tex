...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		\insertimage{ejemplos/test-image.png}{0.2}{Where are you? de \quotesit{Internet}}
...
\section{Aquí un nuevo tema}
	...
	\subsection{Haciendo informes como un profesional}
		...
		\insertimageleft{ejemplos/test-image-wrap}{0.22}{Apolo}{14}
		...
		\insertequationcaptioned{\int_{a}^{b} f(x) dx = \fracnpartial{f(x)}{x}{\eta} \cdotp \textstyle \sum_{x=a}^{b} f(x)\cancelto{1+\frac{\epsilon}{k}}{(1+\Delta x)}}{Ecuación sin sentido}
