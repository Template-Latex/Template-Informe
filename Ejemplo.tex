...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		\newpar{Este es un párrafo, puede contener múltiples \quotes{Expresiones} así como \quotesit{Citas en itálico} o referencias a fórmulas como (\ref{formulasinsentido}), los párrafos añaden una entrada libre por defecto, a continuación se muestra un ejemplo de inserción de imágenes (como la Figura \ref{testimage}):}
		
		\insertimage[\label{testimage}]{ejemplos/test-image.png}{0.2}{Where are you? de \quotesit{Internet}}
