...
\insertimage[\label{p1corte}]{test/img/p1corte}{width=8cm}{Elemento infinitesimal sometido a corte.}
...
\begin{images}{Resultado caso analítico.}
	\addimage{test/img/p1fa}{width=7cm}{Gráfico factor de amplificación.}
