...
%        pablo@ppizarror.com
%
% Manual template: [https://template-latex.github.io/presentacion]
...
\begin{frame}[fragile]{Código fuente (Template)}
	Al igual que \href{https://template-latex.github.io/informe}{Template-Informe}, Template-Presentación ofrece el soporte a todos los lenguajes de programación con el entorno \texttt{sourcecode}. Para usarlo, al igual que \textit{vervatim}, el objeto frame debe tener el argumento opcional \textbf{[fragile]}.
...
\begin{frame}{Citas \& Ecuaciones}
	El template también ofrece opciones para citar \cite{template}. Análogamente, todas las fórmulas de ecuaciones de \href{https://template-latex.github.io/informe}{Template-Informe} son soportadas \eqref{eqn:eqn-larga}:
