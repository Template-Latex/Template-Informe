...
\subsection{Una breve introducción}
	...
	Este es un nuevo párrafo. Para crear un nuevo párrafo basta con usar \textbackslash\textbackslash\ en el anterior, lo que fuerza una nueva línea. También se insertar un nuevo párrafo con el comando \texttt{\textbackslash par}. A partir de la versión 8 del template, los comandos \texttt{\textbackslash newp}, \texttt{\textbackslash newpar} y \texttt{\textbackslash newparnl} fueron eliminados.
...
\subsection{Haciendo reportes como un profesional}
	...
	% (un 35% del ancho de página) y por último su leyenda. Para insertar una
	% imagen flotante en la derecha se utiliza \insertimageright usando los
	% mismos parámetros
	\insertimageleft[\label{img:imagen-izquierda}]{test-image-wrap}{0.35}{Apolo flotando a la izquierda.}
...
\subsection{Otros párrafos más normales}
	...
	\begin{table*}
		\centering
		\caption{Ejemplo de tabla que usa múltiples columnas.}
		\begin{tabular}{cccc}
			\hline
