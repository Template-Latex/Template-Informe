...
\subsection{Otros párrafos más normales}
	...
	\insertimage{test-image-wrap}{width=4cm}{Imagen dentro de párrafo.}
...
\begin{images}[\label{imagenmultiple}]{Ejemplo de imagen múltiple.}
	\addimage[\label{ciudadfoto}]{test-image}{width=6.5cm}{Ciudad}
	\addimageanum{test-image-wrap}{height=4cm}
\end{images}
\end{sourcecode}
	...
	\begin{images}{Ejemplo de imagen múltiple.}
		\addimage{test-image}{width=4cm}{Ciudad}
		\addimageanum{test-image-wrap}{height=4cm}
	\end{images}
...
\begin{anexo}
	...
	\insertimage[\label{img:anexo-2}]{test-image.png}{scale=0.19}{Imagen en anexo.}
