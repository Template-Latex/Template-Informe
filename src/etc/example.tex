...
\section{Aquí un nuevo tema}
	...
	\subsection{Otros párrafos más normales}
		...
		\begin{multicols}{2}
			...
			\insertimagemcfull{ejemplos/test-image}{width=6cm}{top}{Imagen en múltiples columnas.}
			
			% Inserta una imagen simple dentro del párrafo
			\insertimagemc{ejemplos/test-image-wrap}{width=5cm}{Imagen dentro de párrafo.}
