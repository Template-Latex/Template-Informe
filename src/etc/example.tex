...
\subsection{Una breve introducción}
	...
	% (en este caso se definió la escala de 0.1) y una leyenda opcional
	\insertimage[\label{img:testimage}]{ejemplos/test-image.png}{scale=0.1}{Where are you? de \quotes{Internet}.}
