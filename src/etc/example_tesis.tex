...
Para citar usando la librería \textbf{natbib} puedes usar:

\begin{itemize}
	\item \texttt{\textbackslash cite\{einstein\}} \cite{einstein}
	\item \texttt{\textbackslash citet\{einstein\}} \citet{einstein}
	\item \texttt{\textbackslash citep\{einstein\}} \citep{einstein}
\end{itemize}
...
\begin{itemize}
	\item \texttt{\textbackslash cite\{einstein\}} \cite{einstein}
	\item \texttt{\textbackslash shortcite\{einstein\}} \shortcite{einstein}
	\item \texttt{\textbackslash fullcite\{einstein\}} \fullcite{einstein}
\end{itemize}
...
% ------------------------------------------------------------------------------
% BIBLIOGRAFÍA (ESTILO NATBIB), revisar configuración \stylecitereferences
% ------------------------------------------------------------------------------
