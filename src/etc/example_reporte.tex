...
%        pablo@ppizarror.com
%
% Manual template: [https://template-latex.github.io/reporte]
...
\subsectionanum{Otros}
	...
	Recuerda revisar el manual de todas las funciones y configuraciones de este template visitando el siguiente link: \url{https://template-latex.github.io/reporte} \cite{template}. Si encuentras un error en el template, puedes abrir un nuevo issue a través de su página en GitHub.
