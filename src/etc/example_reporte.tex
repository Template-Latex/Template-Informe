...
\subsection{Otros párrafos más normales}
	...
	\begin{multicols}{2}
		...
		\insertimage{ejemplos/test-image-wrap}{width=3.9cm}{Imagen dentro de párrafo.}
...
\begin{images}[\label{imagenmultiple}]{Ejemplo de imagen múltiple.}
	...
	\imagesnewline
	\addimage{ejemplos/test-image}{width=7.6cm}{Ciudad más grande}
\end{images}
\end{sourcecode}
...
\begin{appendixd}
	...
	\insertimage[\label{img:anexo-2}]{ejemplos/test-image.png}{scale=0.16}{Imagen en anexo.}
