...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		\insertimage[\label{img:testimage}]{test-image.png}{scale=0.14}{Where are you? de \quotes{Internet}.}
...
\section{Aquí un nuevo tema}
	...
	\subsection{Haciendo reportes como un profesional}
		...
		% mismos parámetros
		\insertimageleft[\label{img:imagen-izquierda}]{test-image-wrap}{0.3}{Apolo flotando a la izquierda.}
...
\begin{images}[\label{imagenmultiple}]{Ejemplo de imagen múltiple.}
	\addimage{test-image}{width=6.5cm}{Ciudad.}
	\addimage{test-image-wrap}{height=4cm}{Apolo.}
	\imagesnewline
	\addimage{test-image}{width=10cm}{Ciudad más grande.}
\end{images}
\end{sourcecode}
...
\sectionanum{Más ejemplos}
	...
	\subsectionanum{Otros}
		...
		Recuerda revisar el manual de todas las funciones y configuraciones de este template visitando el siguiente link: \url{https://latex.ppizarror.com/reporte} \cite{templateinforme}. Si necesitas una ayuda muy específica sobre el template, o si tienes alguna sugerencia, me puedes enviar un correo a \insertemail{pablo@ppizarror.com}.
...
\section{Cálculos realizados}
	...
	\subsection{Metodología}
		...
		\insertimage[\label{img:anexo-2}]{test-image.png}{scale=0.2}{Imagen en anexo.}
