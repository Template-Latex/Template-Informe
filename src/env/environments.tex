...
% Crea una sección de imágenes múltiples en un entorno multicol
%	#1	Label (opcional)
%	#2	Caption
\newenvironment{imagesmc}[2][]{
	% Modifica globales
	\def\envimageslabelvar {#1}
	\def\envimagescaptionvar {#2}
	\def\GLOBALenvimageinitialized {true}
...
\newenvironment{imagesmcfull}[3][]{
	...
	\ifthenelse{\equal{#2}{bottom}}{%
		\begin{figure*}[b!] \centering \thisfloatpagestyle{fancy}%
		}{%
	\ifthenelse{\equal{#2}{top}}{%
		\begin{figure*}[t!] \centering \thisfloatpagestyle{fancy}%
	}{%
