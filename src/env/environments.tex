...
%	#1	Label (opcional)
%	#2	Posición de la imagen, "bottom", "top", "fixed2", "fixed3", "fixed4"
%	#3	Caption
\newenvironment{imagesmc}[3][]{
	...
	\ifthenelse{\equal{#2}{fixed2}}{%
		\end{multicols} \begin{figure*}[h] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed2b}}{%
		\end{multicols} \begin{figure*}[b] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed2t}}{%
		\end{multicols} \begin{figure*}[t] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed3}}{%
		\end{multicols} \begin{figure*}[h] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed3b}}{%
		\end{multicols} \begin{figure*}[b] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed3t}}{%
		\end{multicols} \begin{figure*}[t] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed4}}{%
		\end{multicols} \begin{figure*}[h] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed4b}}{%
		\end{multicols} \begin{figure*}[b] \centering%
	}{%
	\ifthenelse{\equal{#2}{fixed4t}}{%
		\end{multicols} \begin{figure*}[t] \centering%
	}{%
	...
	\end{figure*}%
	\ifthenelse{\equal{\envimagesmcpos}{fixed2}}{%
		\begin{multicols}{2}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed2b}}{%
		\begin{multicols}{2}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed2t}}{%
		\begin{multicols}{2}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed3}}{%
		\begin{multicols}{3}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed3b}}{%
		\begin{multicols}{3}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed3t}}{%
		\begin{multicols}{3}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed4}}{%
		\begin{multicols}{4}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed4b}}{%
		\begin{multicols}{4}
	}{
	\ifthenelse{\equal{\envimagesmcpos}{fixed4t}}{%
		\begin{multicols}{4}
	}{
	}}}}}}}}}
