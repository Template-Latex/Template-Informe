...
\def\sitemsmargini {25}            % Margen items nivel 1 [pt]
\def\sitemsmarginii {22}           % Margen items nivel 2 [pt]
\def\sitemsmarginiii {18.7}        % Margen items nivel 3 [pt]
\def\sitemsmarginiv {17}           % Margen items nivel 4 [pt]
