...
\def\coreintializetitlenumbering {%
	...
	\ifthenelse{\equal{\GLOBALchapternumenabled}{false}}{%
		...
		\ifthenelse{\equal{\GLOBALsectionalph}{true}}{%
			\renewcommand{\thesection}{%
				\thechapter\charbetwchaptersection\Alph{section}%
			}%
		}{%
			\renewcommand{\thesection}{%
				\thechapter\charbetwchaptersection\arabic{section}%
			}%
		}%
	}%
	% Subsection
	\ifthenelse{\equal{\GLOBALsectionanumenabled}{true}}{%
		...
		\renewcommand{\thesubsection}{%
			\thesection\charbetwsectionsubsection\arabic{subsection}%
		}%
	}%
	% Subsubsection
	\ifthenelse{\equal{\GLOBALsubsectionanumenabled}{true}}{%
		...
		\renewcommand{\thesubsubsection}{%
			\thesubsection\charbetwsubsectionssect\arabic{subsubsection}%
		}%
	}%
	% Subsubsubsection
	\ifthenelse{\equal{\GLOBALsubsubsectionanumenabled}{true}}{%
		...
		\renewcommand{\thesubsubsubsection}{%
			\thesubsubsection\charbetwssectionsssect\arabic{subsubsubsection}%
		}%
	}%
	\hbadness=10000%
}
