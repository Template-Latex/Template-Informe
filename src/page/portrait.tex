...
\newcommand{\templatePortrait}{
	...
	\ifthenelse{\equal{\portraitstyle}{style9}}{
		...
		% Título del informe
		\noindent \hspace{-0.25cm} \coreinsertkeyimage{\imagendepartamentoparams}{\imagendepartamento}
		\vfill
		\begin{center}
			\noindent \rule{\linewidth}{0.4mm} \\ \vspace{0.3cm}
			{\huge \textcolor{\portraittitlecolor}{\titulodelinforme} \vspace{0.2cm} \\}
	...
	\ifthenelse{\equal{\portraitstyle}{style13}}{
		...
		\begin{flushright}
			\begin{minipage}{0.3\linewidth}%
				\noindent \coreinsertkeyimage{\imagendepartamentoparams}{\imagendepartamento}%
			\end{minipage}
		\end{flushright}
