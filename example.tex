...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		% imagen.
		Este template ha sido diseñado para que sea completamente compatible con editores \LaTeX\ para escritorio y de manera online \cite{overleaf}. La compilación es realizada siempre usando las últimas versiones de las librerías, además se incluyen los parches oficiales para evitar cualquier tipo de \textit{warnings} en la consola.
