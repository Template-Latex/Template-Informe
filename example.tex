...
\section{Aquí un nuevo tema}
	...
	\subsection{Ejemplos de inserción de código fuente}
		...
		El template permite la inserción de los siguientes lenguajes de programación de forma nativa: C, C++, C++, docker, HTML5, Java, Javascript, JSON, Matlab, LaTeX, perl, PHP, Python, Ruby, SQL y XML. Para insertar código fuente se debe usar el entorno \texttt{sourcecode}. \newp
...
\begin{sourcecode}{latex}{Código para insertar una imagen múltiple mediante el entorno \texttt{images}, tanto el \texttt{label} como la leyenda son opcionales.}
