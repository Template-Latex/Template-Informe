...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		\insertimage[\label{img:testimage}]{ejemplos/test-image.png}{scale=0.17}{Where are you? de \quotesit{Internet}}
...
\section{Aquí un nuevo tema}
	...
	\subsection{Haciendo informes como un profesional}
		...
		\insertequationcaptioned[\label{eqn:formulasinsentido}]{\int_{a}^{b} f(x) dx = \fracnpartial{f(x)}{x}{\eta} \cdotp \textstyle \sum_{x=a}^{b} f(x)\cancelto{1+\frac{\epsilon}{k}}{(1+\Delta x)}}{}
