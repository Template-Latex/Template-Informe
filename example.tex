...
\sectionanum{Más ejemplos}
	...
	\subsectionanum{Otros}
		...
		Recuerda revisar el \hl{manual} de todas las funciones de este template visitando el siguiente link: \url{http://ppizarror.com/Template-Informe/}. Además si necesitas una ayuda muy específica sobre el template me puedes enviar un correo a \href{mailto:pablo.pizarro@ing.uchile.cl}{\texttt{pablo.pizarro@ing.uchile.cl}}.
