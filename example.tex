...
\sectionanum{Más ejemplos}
	...
	% Inserta un subtítulo sin número
	\subsectionanum{Listas, Enumeraciones, etc}
	
		Hacer listas con \LaTeX es muy fácil, para eso debes usar el comando \texttt{\textbackslash begin\{enumerate\}}, cada elemento empieza por \texttt{\textbackslash item}, resultando:
		...
		También se puede cambiar el tipo de enumeración, se pueden usar letras, números romanos, entre otros. Esto se logra cambiando el \textbf{label} del objeto \texttt{enumerate}. A continuación se muestra un ejemplo usando letras con el estilo \texttt{\textbackslash alph}:
		...
		Además de enumeraciones con números romanos y letras griegas
