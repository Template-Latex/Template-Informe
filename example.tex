...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		% Se añade parrafo de prueba, notar que no se requiere añadir un salto de línea, ni \par debido a que todas las funciones del template hacen eso por defecto
...
\section{Aquí un nuevo tema}
	...
	\subsection{Haciendo informes como un profesional}
		...
		\insertimageleft[\label{img:imagen-izquierda}]{ejemplos/test-image-wrap}{0.3}{17}{Apolo.}
	...
	\subsection{Otros párrafos más normales}
		...
		\insertgathered[\label{eqn:eqn-larga}]{
			\lpow{\Lambda}{f} = \frac{L\cdot f}{W} \cdot \frac{\pow{\bm{\lpow{Q}{e}}}{2}}{8 \pow{\pi}{2} \pow{W}{4} g} + \sum_{i=1}^{l} \frac{f \cdot \big( M - d\big)}{l \cdot W} \cdot \frac{\pow{\big(\lpow{Q}{e}- i\cdot Q\big)}{2}}{8 \pow{\pi}{2} \pow{W}{4} g}\\
			Q_e = Q \cdot \int_{0}^{e} V(x) \text{dx}
		}
