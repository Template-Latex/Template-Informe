...
\newcommand{\insertimage}[4][]{         % Insertar una imagen
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=#3]{\defaultimagefolder#2}
		\caption{#4 #1}
	\end{figure}
...
\newcommand{\insertimageboxed}[4][]{    % Insertar una imagen con recuadro
	...
	\begin{figure}[H]
		\centering
		\fbox{\includegraphics[scale=#3]{\defaultimagefolder#2}}
		\caption{#4 #1}
	\end{figure}
	\vspace{\defaultmarginbottomimages}}
\newcommand{\insertdoubleimage}[8][]{   % Insertar una imagen doble
	...
	\begin{figure}[H] \centering
		\subfloat[#4]{
			\includegraphics[scale=#3]{\defaultimagefolder#2}}
		\subfloat[#7]{
			\includegraphics[scale=#6]{\defaultimagefolder#5}}
		\caption{#8 #1}
	\end{figure}
	\vspace{\defaultmarginbottomimages}
