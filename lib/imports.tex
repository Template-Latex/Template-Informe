...
\usepackage[spanish,es-nosectiondot]{babel}	% Idioma del documento en español
...
\ifthenelse{                  % Paquete para configurar el núcleo
	\equal{\referenceassection}{true}}{
	\usepackage{etoolbox}}{
}
...
\ifthenelse{                  % Idioma del documento en español
	\equal{\showdotontitle}{true}}{
	\usepackage{titlesec}
