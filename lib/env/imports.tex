...
\ifthenelse{\equal{\equationleftalign}{true}}{ % Librerías matemáticas
...
% xcolor al cargar table ya importa colortbl (v6.3.3)
% \usepackage{colortbl}      % Administración de color en las tablas

% -----------------------------------------------------------------------------
% LIBRERÍAS CONDICIONALES
% -----------------------------------------------------------------------------
\ifthenelse{\equal{\footnotepagetoprule}{true}}{ % Regla superior
	\usepackage[bottom,hang]{footmisc} % Estilo pie de página
}{
	\usepackage[bottom,norule,hang]{footmisc}
}
\ifthenelse{\equal{\showdotaftersnum}{true}}{ % Agrega punto a títulos/subtítulos
	\usepackage{secdot}
...
\ifthenelse{\equal{\fontdocument}{venturis}}{
	...
	\throwbadconfig{Fuente desconocida}{\fontdocument}{lmodern,arial,arial2,helvet,times,
...
\ifthenelse{\equal{\fonttypewriter}{texgyrecursor}}{
	...
	\throwbadconfig{Fuente desconocida}{\fonttypewriter}{anonymouspro,ascii,beramono,cmpica,courier,
		dejavusansmono,firamono,gomono,inconsolata,kpmonospaced,lcmtt,newtxtt,
		nimbusmono,nimbusmononarrow,texgyrecursor,tmodern}
	}}}}}}}}}}}}}}}}
}
