...
\newcommand{\coreinitsourcecodep}[4]{
	...
	\def\GLOBALcaptiondefn{EMPTY-VAR} % Elimina el caption
}
...
\newcommand{\coreinitsourcecode}[3]{
	...
	\def\GLOBALcaptiondefnsrc{\GLOBALcaptiondefn}
	\resetindexcaption
	\ifthenelse{\equal{\codecaptiontop}{true}}{
		\ifx\hfuzz#3\hfuzz
			\lstset{
...
\newenvironment{images}[2][]{
	...
	% Guarda el entorno
	\def\GLOBALcaptiondefnimages {\GLOBALcaptiondefn}
	\resetindexcaption
	...
	\begin{figure}[H] \centering
		...
		\ifthenelse{\equal{\envimagescaptionvar}{}}{ % \ifx\hfuzz no sirve
			...
			\ifthenelse{\equal{\GLOBALcaptiondefnimages}{EMPTY-VAR}}{
				\caption{\envimagescaptionvar\envimageslabelvar}
			}{
				\caption[\GLOBALcaptiondefnimages]{\envimagescaptionvar\envimageslabelvar}
			}
		}
	\end{figure}
	...
	\def\GLOBALcaptiondefnimages{EMPTY-VAR} % Elimina el caption
}
