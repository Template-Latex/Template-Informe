...
\newcommand{\coreinitsourcecodep}[4]{
	...
	\ifthenelse{\equal{\codecaptiontop}{true}}{
		...
		\else
			\ifx\hfuzz#3\hfuzz
				\ifthenelse{\equal{\GLOBALcaptiondefnsrc}{EMPTY-VAR}}{
					\lstset{
						caption={#4 #1},
						captionpos=t,
						style=#2
					...
					\lstset{
						caption={[\GLOBALcaptiondefnsrc]#4 #1},
						captionpos=t,
						style=#2
					}
				}
	...
	\ifthenelse{\equal{\codecaptiontop}{true}}{
		...
		\else
			\ifthenelse{\equal{\GLOBALcaptiondefnsrc}{EMPTY-VAR}}{
				...
				\lstset{
					style=#2,
					caption={[\GLOBALcaptiondefnsrc]#3 #1},
					captionpos=t
				}
			}
		\fi
