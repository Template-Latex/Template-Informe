...
\newenvironment{references}{
	...
	\begingroup
	\ifthenelse{\equal{\refassection}{true}}{ % Se configura las referencias como una sección
		\section{\namereferences}
	}{
		\sectionanum{\namereferences}
	}
	\renewcommand{\section}[2]{}
	\begin{thebibliography}{99} % Inicia la bibliografía
	}
	{
	\end{thebibliography}
...
\newenvironment{anexo}{
	...
	\appendixtitleon % Añade al índice marcadores
	...
	\bookmarksetupnext{level=0} % Reestablece índice marcador
	\endgroup
}
