...
\newcommand{\insertimageleftboxed}[5][]{
	...
	\emptyvarerr{\insertimageleftboxed}{#3}{Ancho de la imagen no defindo}
...
\newcommand{\insertimageleftline}[5][]{
	...
	%	#5	Leyenda de la imagen (opcional)
	\emptyvarerr{\insertimageleftline}{#2}{Direccion de la imagen no definida}
	\emptyvarerr{\insertimageleftline}{#3}{Ancho de la imagen no defindo}
	\emptyvarerr{\insertimageleftline}{#4}{Altura en lineas de la imagen flotante izquierda no definida}
...
\newcommand{\insertimageleftlineboxed}[6][]{
	...
	\emptyvarerr{\insertimageleftlineboxed}{#3}{Ancho de la imagen no defindo}
...
\newcommand{\insertimagerightline}[5][]{
	...
	%	#4	Altura en líneas de la imagen
	%	#5	Leyenda de la imagen (opcional)
	\emptyvarerr{\insertimagerightline}{#2}{Direccion de la imagen no definida}
	\emptyvarerr{\insertimagerightline}{#3}{Ancho de la imagen no defindo}
	\emptyvarerr{\insertimagerightline}{#4}{Altura en lineas de la imagen flotante derecha no definida}
