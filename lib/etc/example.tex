...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		% Esta instrucción, añadida en la v6.6.0 permite cambiar el título de cada
		% objeto en el índice de cada objeto. Este título es solo válido hasta el
		% primer objeto que lo llame, luego este se reestablecerá
...
\setindexcaption{Título del código de Matlab en el índice.}
\GLOBALcaptiondefn
