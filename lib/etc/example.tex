...
\section{Aquí un nuevo tema}
	...
	\subsection{Ejemplos de inserción de código fuente}
		...
		% A continuación se crea una función auxiliar, esta es una herramienta extremadamente importante y muy útil.
		% Esta función toma dos parámetros, uno es el lenguaje del código fuente, el segundo el identificador en el manual
		\newcommand{\insertsrcmanual}[2]{
			\href{http://latex.ppizarror.com/informe.html\#hlp-srccode\&srctype=#1}{#2}
		}
	
		El template permite la inserción de los siguientes lenguajes de programación de forma nativa: \insertsrcmanual{c}{C}, C\#, C++, DOCKER, HTML5, Java, Javascript, JSON, Matlab, LaTeX, Perl, PHP, Python, Ruby, SQL y XML. Para insertar código fuente se debe usar el entorno \texttt{sourcecode}. \newp
		
		A continuación se presenta un ejemplo de inserción de código fuente en Python \footnote{El mejor lenguaje de programación del mundo.} (Código \ref{codigo-python}), Java (Código \ref{codigo-java}) y Matlab (Código \ref{codigo-matlab}):
