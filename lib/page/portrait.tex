...
\input{lib/page/portrait-config} % !FILE <STRIP,NL,DELCOM>
...
\ifthenelse{\equal{\portraitstyle}{style15}}{
	...
	\checkextravarexist{\imagenextraportadaA}{}
	\checkextravarexist{\imagenextraportadaescalaA}{}
	...
	\noindent \begin{minipage}{0.2\textwidth}
		\begin{flushright}
			\ifthenelse{\isundefined{\imagenextraportadaA}}{}{
				\ifthenelse{\isundefined{\imagenextraportadaescalaA}}{}{
					\noindent \includegraphics[scale=\imagenextraportadaescalaA]{\imagenextraportadaA} \\
				}
			}
		\end{flushright}
	\end{minipage}
...
\ifthenelse{\equal{\portraitstyle}{style16}}{
	...
	\checkextravarexist{\imagenfondoportadaB}{Defina el fondo de la portada en el archivo lib/page/portrait-config.tex (VERSION NORMAL) o bien en el bloque . Por defecto se uso la portada ubicada en ejemplos}
	\checkextravarexist{\colorbloqueportadaB}{Defina el color del bloque del titulo de la portada en el bloque INFORMACION DEL DOCUMENTO. Por defecto se uso el color ocre}
	
	\begingroup
	\thispagestyle{empty}
	\begin{tikzpicture}[remember picture,overlay]
		\node[inner sep=0pt] (background) at (current page.center) {\includegraphics[width=\paperwidth]{\imagenfondoportadaB}};
		\draw (current page.center) node [fill=\colorbloqueportadaB!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{
