...
\ifthenelse{\equal{\portraitstyle}{style3}}{
	...
	\begin{center}
		...
		\Huge \textup \bfseries \textsc{\textcolor{\portraittitlecolor}{\titulodelinforme}} \\ [0.4cm]
...
\ifthenelse{\equal{\portraitstyle}{style4}}{
	...
	\begin{center}
		...
		\noindent \textcolor{\portraittitlecolor}{\titulodelinforme} \\
		\vspace*{0.35cm}
		\noindent \textcolor{\portraittitlecolor}{\large{\codigodelcurso\ - \nombredelcurso}} \\
		\vspace*{3cm}
	\end{center}
...
\ifthenelse{\equal{\portraitstyle}{style7}}{
	...
	\vspace{6.0cm}
	\begin{center}
		{\Huge \textcolor{\portraittitlecolor}{\scshape{\titulodelinforme}} \vspace{0.6cm}} \\
		{\Large \textcolor{\portraittitlecolor}{\scshape{\temaatratar}}}
	\end{center}
...
\ifthenelse{\equal{\portraitstyle}{style9}}{
	\setpagemargincm{\pagemarginleft}{\pagemargintop}{\pagemarginright}{\pagemarginbottom}
	\pagestyle{empty}
	\noindent \includegraphics[scale=\imagendepartamentoescala]{\imagendepartamento} \vspace{6.5cm} \\
	
	\noindent {\bf \huge \textcolor{\portraittitlecolor}{\textsf{\MakeUppercase{\titulodelinforme}} \vspace*{0.3cm}}} \\
	\noindent {\bf \large \textcolor{\portraittitlecolor}{\textsf{\MakeUppercase{\temaatratar}}}} \\
