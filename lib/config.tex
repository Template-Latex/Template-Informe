...
\def\portraitstyle {style1}        % Estilo portada (18 estilos)
...
\def\marginalignbottom {-0.40}     % Margen inferior ecuaciones [cm]
...
\def\marginequationtop {-0.05}     % Margen superior ecuaciones [cm]
...
\def\marginrightmultimage {0.50}   % Margen derecho imágenes múltiples [cm]
