...
\def\equationrestart {sec}         % N° ecuación (none,page,sec,ssec,sssec,ssssec)
...
\def\footnoterestart {none}        % N° footnote (none,page,sec,ssec,sssec,ssssec)
...
\def\showsectioncaption {none}     % N° sec. en objeto (none,sec,ssec,sssec,ssssec)
