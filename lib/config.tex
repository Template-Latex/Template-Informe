...
\def\indexstyle {}              % Estilo índice: f:figura, t:tabla, c:código
...
\def\marginequationbottom {-0.20}  % Margen inferior ecuaciones [cm]
...
\def\margingatherbottom {-0.40}    % Margen inferior entorno gather [cm]
...
\def\margingatheredbottom {-0.40}  % Margen inferior entorno gathered [cm]
\def\margingatheredcaptbottom{0.0} % Margen inferior entorno gathered caption [cm]
