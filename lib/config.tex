...
\def\defaultmarginfloatimages {-13pt}    % Margen sup. figura flotante [pt]
...
\def\namereferences {Referencias}        % Nombre de las referencias
...
\def\nomltsrc {Lista de Código Fuente}   % Nombre del índ. de la lista de código
...
\def\figurecaptiontop {false}      % Caption de las figuras en la parte superior
