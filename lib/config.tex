...
\def\pdfcompilecompression {9}     % Factor de compresión del pdf (1-9)
\def\pdfcompileobjcompression {2}  % Nivel compresión objetos del pdf (0-2)
\def\pdfcompileversion {5}         % Versión mínima del pdf compilado
