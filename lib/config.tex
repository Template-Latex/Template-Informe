...
\def\showsectioncaption {none}    % N° de la sección en obj. (none,sec,ssec,sssec)
...
\def\stylecitereferences {bibtex} % Estilo cita y ref. (bibtex,apacite,natbib)
\def\twocolumnreferences {false}  % Referencias en dos columnas

% CONFIGURACIÓN DE LOS TÍTULOS
\def\anumsecaddtocounter {true}   % Insertar títulos 'anum' aumenta n° de secciones
