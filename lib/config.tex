...
\def\hfcoursewidth {0.35}          % Tamaño máximo del curso en header-footer
\def\hftitlewidth {0.6}            % Tamaño máximo del título en header-footer
\def\hfstyle {style1}              % Estilo header-footer (15 estilos)
...
\def\tablerowfirst {none}          % Primer color de celda de las tablas
\def\tablerowsecond {gray!15}      % Segundo color de celda de las tablas
