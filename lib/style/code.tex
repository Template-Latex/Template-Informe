...
\lstdefinestyle{latex}{
	...
	morekeywords={addimage,addimageboxed,align,begin,insertalign,insertaligned,
		inserteqimage,insertequation,insertequationcaptioned,insertgather,insertgathered,
		insertimage,insertimageleft,insertimageright,label,lipsum,newp,newpage,section,
		sourcecode,sourcecodep,subsection,subsubsection,subsubsubsection},
	showstringspaces=false,
	tabsize=3
}
