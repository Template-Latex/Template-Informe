...
\lstdefinestyle{opensees}{
	language=tcl,
	breakatwhitespace=false,
	emph=[1]{-dir,-dof,-ele,-eleRange,-file,-height,-increment,-initial,-iNode,
		-iterate,-jNode,-kNode,-mat,-matConcrete,-matShear,-matSteel,-maxDim,
		-maxEta,-maxIter,-minEta,-ndf,-ndm,-node,-nodeRange,-numSublevels,
		-numSubSteps,-region,-rho,-thick,-time,-tol,-type,-width},
	emphstyle=[1]\color{black}\bfseries\em,
	% moredelim=[s][\color{black}\bfseries\em]{-}{\ },
	keepspaces=true,
	morecomment=[l]{\#},
	morekeywords={algorithm,analysis,analyze,constraints,deformation,disp,
		DisplayModel2D,DisplayModel3D,element,equalDOF,fix,fixX,fixY,fixZmodel,
		geomTransf,initialize,integrator,loadConst,mass,node,numberer,pattern,
		printA,reaction,recorder,region,section,system,test,uniaxialMaterial,wipe},
	ndkeywords={Aggregator,BandGeneral,BasicBuilder,BFGS,Broyden,
		constraintsTypeGravity,DeformedShape,DisplacementControl,Elastic,
		elasticBeamColumn,EnergyIncr,KrylovNewton,Linear,LoadControl,LoadControl,
		ModifiedNewton,Newton,NewtonLineSearch,Node,NodeNumbers,nonlinearBeamColumn,
		NormDispIncr,numberer,pattern,Plain,rayleigh,RCM,SecantNewton,
		SparseGeneral,Static,Steel01,Transient,truss,ViewScale,zeroLength},
