...
\lstdefinestyle{matlab}{
	language=Matlab,
	keepspaces=true,
	morekeywords={addOptional,box,break,catch,cell,continue,end,for,if,isa,
		ltitr,matlab2tikz,methods,movegui,ones,parse,properties,repmat,strcat,
		try,warning,xlim,ylim}
}
