...
\lstdefinestyle{latex}{
	...
	insertgather,insertgathered,insertimage,insertimageleft,insertimageright,
	label,lipsum,newp,newpage,section,sourcecode,sourcecodep,subsection,
...
\newcommand{\checkvalidsourcecodestyle}[1]{
	...
	\ifthenelse{\equal{#1}{xml}}{}{
		...
		csharp,docker,html5,java,js,json,latex,matlab,perl,php,plaintext,
