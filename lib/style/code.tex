...
\lstdefinestyle{algorithm}{
	...
	frame=tB,
	keepspaces=true,
	keywords={input,output,return,datatype,function,in,if,else, foreach,while,begin,end,do,and,or,xor},
...
\newcommand{\checkvalidsourcecodestyle}[1]{
	...
	\ifthenelse{\equal{#1}{xml}}{}{
		...
		\throwbadconfig{Estilo de codigo desconocido}{\sourcecodestyle}{algorithm,c,cpp,csharp,docker,html5,java,js,json,latex,matlab,perl,php,plaintext,python,ruby,sql,xml}
	}}}}}}}}}}}}}}}}}}
}
