...
\lstdefinelanguage{docker}{
	comment=[l]{\#},
	keywords={ADD,CMD,COPY,ENTRYPOINT,ENV,EXPOSE,FROM,LABEL,MAINTAINER,ONBUILD,RUN,STOPSIGNAL,USER,VOLUME,WORKDIR},
	morestring=[b]',
	morestring=[b]"
}
...
\lstdefinelanguage{HTML5}{
	...
	alsoletter={<>=-},
	morecomment=[s]{<!--}{-->},
	ndkeywords={-moz-transform:,<!,<body>,<canvas,</body>,</canvas>,</head>,</html>,</script>,</style>,</title>,<head>,<meta,<script>,<style>,<title>,=,><,border:,charset=,/>,height=,html>,id=,otherkeywords={<html>,transform:,transition-duration:,transition-property:,transition-timing-function:},width=},
	sensitive=true,
	tag=[s]
}
...
\lstdefinelanguage{JavaScript}{
	...
	identifierstyle=\color{black},
	keepspaces=true,
	keywords={async,await,break,case,catch,catch,do,else,false,function,if,in,new,null,return,switch,true,typeof,var,while},
	keywordstyle=\color{blue},
	morecomment=[s]{/*}{*/},
	morestring=[b]',
	morestring=[b]",
...
\lstdefinestyle{latex}{
	...
	keywordstyle=\color{blue}\bfseries,
	morekeywords={addimage,addimageboxed,align,begin,insertalign,insertaligned,insertdoubleqimage,inserteqimage,insertequation,insertequationcaptioned,insertgather,insertgathered,insertimage,insertimageleft,insertimageright,label,lipsum,newp,newpage,section,sourcecode,sourcecodep,subsection},
	showstringspaces=false,
	tabsize=3
}
...
\lstdefinestyle{php}{
	...
	emph=[3]{abstract,as,const,else,elseif,endfor,endforeach,endif,extends,final,for,foreach,global,if,implements,private,protected,public,static,var},
...
\lstdefinestyle{pseudocode}{
	...
	frame=tB,
	keepspaces=true,
	keywords={and,be,begin,datatype,do,elif,else,end,for,foreach,fun,function,if,in,input,let,null,or,output,pop,procedure,push,repeat,return,swap,until,while,xor},
...
\newcommand{\checkvalidsourcecodestyle}[1]{
	...
	\ifthenelse{\equal{#1}{xml}}{}{
		...
		\throwbadconfig{Estilo de codigo desconocido}{\sourcecodestyle}{c,cpp,csharp,docker,html5,java,js,json,latex,matlab,perl,php,plaintext,pseudocode,python,ruby,sql,xml}
	}}}}}}}}}}}}}}}}}}
}
