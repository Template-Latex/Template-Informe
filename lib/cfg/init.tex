...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={6.0.8-N},
		Template.Version.Hash={E25FAEE4C13F75E36533C3B0BC936036},
		Template.Version.Release={6.0.8},
	...
	pdfproducer={Template-Informe v6.0.8 | (Pablo Pizarro R.) ppizarror.com},
...
\ifthenelse{\equal{\objectmarginstyle}{small}}{
	...
	\def\marginrightmultimage {-0.6} % Margen derecho imágenes múltiples [cm]
	\def\margintopimages {-0.2} % Margen superior figura [cm]
	\def\margintopmultimages {-0.5} % Margen superior imágenes múltiples [cm]
}{
\ifthenelse{\equal{\objectmarginstyle}{normal}}{
	...
	\def\marginequationcaptionbottom {0.0} % Margen inferior caption ecuación [cm]
	\def\marginequationcaptiontop {-0.65} % Margen superior caption ecuación [cm]
	...
	\def\marginrightmultimage {-1.0} % Margen derecho imágenes múltiples [cm]
...
\ifthenelse{\equal{\objectmarginstyle}{large}}{
	...
	\def\margintopimages {0.2} % Margen superior figura [cm]
	\def\margintopmultimages {0.0} % Margen superior imágenes múltiples [cm]
}{
