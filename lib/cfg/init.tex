...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={5.2.2-N},
		Template.Version.Hash={D028F6E1096F53C90C31C10FB5C6307C},
		Template.Version.Release={5.2.2},
	...
	pdfproducer={Template-Informe v5.2.2 | (Pablo Pizarro R.) ppizarror.com},
...
\begingroup
	...
	\def\cftlstlistingindent {1.5em} % Identado de los números margen izq
	\makeatother
\endgroup
