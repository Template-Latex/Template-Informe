...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.0.1-3-N},
		Template.Version.Hash={E5E752B5F5AF8590431B6C47AC61C8B0},
	...
	pdfproducer={Template-Informe v4.0.1 | (Pablo Pizarro R.) ppizarror.com},
	pdfstartpage={1},
	pdfstartview={FitH},
...
\graphicspath{{./\defaultimagefolder}{./../\defaultimagefolder}}
...
\ifthenelse{\equal{\figurecaptiontop}{true}}{
	% Se dejan los caption en la parte superior de las figuras
	\floatsetup[figure]{
		position=above
	}}{
}
\ifthenelse{\equal{\tablecaptiontop}{true}}{
	% Se dejan los caption en la parte superior de las tablas
	\floatsetup[table]{
		position=top}
	}{
	\floatsetup[table]{
...
\ifthenelse{\equal{\captionalignment}{right}}{
	...
	\errmessage{Error: Posicion de leyendas desconocida \noexpand \captionalignment= \captionalignment}
}
}}}
...
\ifthenelse{\equal{\enablecitenatbib}{true}}{
	\ifthenelse{\equal{\citesuperscript}{true}}{
		% Cite con textsuperscript
		\setcitestyle{super,open={\citestartchar},close={\citeendchar}}}{
		\setcitestyle{open={\citestartchar},close={\citeendchar}}
	}}{
}
