...
\floatsetup[figure]{
	...
	captionskip=\captiontbmarginfig pt
}
\floatsetup[table]{
	% Configuración de márgenes en las tablas
	captionskip=\captiontbmargintbl pt
}
...
% Se declara el estilo de grados para la librería siunitx
