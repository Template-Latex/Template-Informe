...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.6.4-N},
		Template.Version.Hash={C003DBBF0CB37DDACA0615B2478CA0C3},
		Template.Version.Release={4.6.4},
	...
	pdfproducer={Template-Informe v4.6.4 | (Pablo Pizarro R.) ppizarror.com},
...
\ifthenelse{\equal{\showlinenumbers}{true}}{ % Espaciado entre número de línea y texto
...
\begingroup
	...
	\def\cftlstlistingindent{1.48em}
