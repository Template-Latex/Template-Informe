...
\def\varSectionAnumEnabled{false}
\def\varSubSectionAnumEnabled{false}
...
\pretocmd{\subsection}{
	\ifthenelse{\equal{\varSectionAnumEnabled}{true}}{
...
\pretocmd{\subsubsection}{
	\ifthenelse{\equal{\varSubSectionAnumEnabled}{true}}{
...
\newcommand{\sectionanum}[1]{
	...
	\def\varSectionAnumEnabled{true}
}
...
\newcommand{\subsectionanum}[1]{
	...
	\def\varSubSectionAnumEnabled{true}
}
