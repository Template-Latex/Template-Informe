...
% Insertar una imagen a la izquierda, ajustada en un número de líneas
% 	#1	Label (opcional)
%	#2	Dirección de la imagen
%	#3	Ancho de la imagen (en textwidth)
...
% Insertar una imagen recuadrada a la izquierda, ajustada en un número de líneas
% 	#1	Label (opcional)
%	#2	Dirección de la imagen
%	#3	Ancho de la imagen (en textwidth)
%	#4	Altura en líneas de la imagen
...
% Insertar una imagen recuadrada a la derecha
% 	#1	Label (opcional)
%	#2	Dirección de la imagen
%	#3	Ancho de la imagen (en textwidth)
%	#4	Ancho de la línea (en pt)
...
% Insertar una imagen a la derecha, ajustada en un número de líneas
% 	#1	Label (opcional)
%	#2	Dirección de la imagen
%	#3	Ancho de la imagen (en textwidth)
%	#4	Altura en líneas de la imagen
...
% Insertar una imagen recuadrada a la derecha, ajustada en un número de líneas
% 	#1	Label (opcional)
%	#2	Dirección de la imagen
%	#3	Ancho de la imagen (en textwidth)
%	#4	Altura en líneas de la imagen
