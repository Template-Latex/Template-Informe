...
\newcommand{\insertequationcaptioned}[3][]{
	...
	\emptyvarerr{\insertequationcaptioned}{#3}{Caption no definido}
	\vspace{0cm}
	\begin{equation}
		\text{#1} #2
	\end{equation}
...
\newcommand{\insertequationgatheredcaptioned}[3][]{
	...
	\emptyvarerr{\insertequationgatheredcaptioned}{#3}{Caption no definido}
	\vspace{0cm}
	\begin{gather}
		\text{#1} #2
	\end{gather}
...
\newcommand{\insertequationaligncaptioned}[3][]{
	...
	\emptyvarerr{\insertequationaligncaptioned}{#3}{Caption no definido}
	\vspace{0cm}
	\begin{align}
		\text{#1} #2
	\end{align}
