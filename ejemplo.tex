...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		\insertimage[\label{testimage}]{ejemplos/test-image.png}{scale=0.17}{Where are you? de \quotesit{Internet} \protect\footnotemark}
...
\section{Aquí un nuevo tema}
	...
	\subsection{Otros párrafos más normales}
		...
		\insertequationalign[\label{eqn-larga}]{\lpow{\Lambda}{f} = \frac{L\cdot f}{W} \cdot \frac{\pow{\lpow{Q}{e}}{2}}{8 \pow{\pi}{2} \pow{W}{4} g}+ \sum_{i=1}^{l} \frac{f \cdot \big( M - d\big)}{l \cdot W} \cdot \frac{\pow{\big(\lpow{Q}{e}- i\cdot Q\big)}{2}}{8 \pow{\pi}{2} \pow{W}{4} g}}
