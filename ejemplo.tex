...
% NUEVA SECCIÓN
\newtitleanum{Aquí un nuevo tema} % Inserta un título (similar a una sección) sin número
...
\section{Más ejemplos}
	...
	A continuación se presenta un ejemplo de inserción de código fuente (Python y Java):
