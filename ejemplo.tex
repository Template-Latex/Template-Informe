...
\section{Informes con \LaTeX}
	...
	\subsection{Una breve introducción}
		...
		\insertimage[\label{testimage}]{ejemplos/test-image.png}{scale=0.2}{Where are you? de \quotesit{Internet} \protect\footnotemark}
		\footnotetext{ Imagen obtenida desde Internet}
...
\section{Aquí un nuevo tema}
	...
	% SUB-SECCIÓN
	\newsubtitleanum{Haciendo informes como un profesional}
...
% NUEVA SECCIÓN
\newpage	
\newtitleanum{Más ejemplos} % Inserta un título (similar a una sección) sin número, una vez que se inserta un título así no se pueden volver a usar los títulos numerados
