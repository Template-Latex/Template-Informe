...
\def\linkcolor {black}            % Color de los links del documento (\ref,índice,etc.)
\def\maintextcolor {black}        % Color principal del texto
\def\portraittitlecolor {black}   % Color de los títulos de la portada
\def\showborderonlinks {false}    % Cambia el color de un link por un recuadro de color
