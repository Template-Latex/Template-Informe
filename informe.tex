...
\def\templateversion{3.6.8}               % Versión del template
...
\def\numberedequation {false}      % Ecuaciones con \insert... numeradas
...
\input{test.tex} % Ejemplo, se puede borrar
