...
\newcommand{\newtitleanumheadless}[1]{    % Insertar un título sin número sin alterar el header
	\addcontentsline{toc}{section}{#1}
	\section*{#1}
	\stepcounter{section}
}
...
\newcommand{\inserttripleimage}[8][]{     % Insertar una imagen triple
	\vspace{\defaultmargintopimages}
	\captionsetup{margin=0.45cm}
	\begin{figure}[H] \centering
		\subfloat[]{
...
\hypersetup{
	...
	pdfproducer={Template LaTeX informe v2.3.4}}
