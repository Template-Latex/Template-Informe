...
\def\templateversion{3.3.8}               % Versión del template
...
\def\pagemarginbottom {2.7}
\def\pagemarginleft {2.5}
\def\pagemarginright {2.5}
\def\pagemargintop {3.0}
