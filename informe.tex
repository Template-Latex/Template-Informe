...
\def\templateversion{3.2.6}               % Versión del template
...
\def\imagendeldepartamento {images/departamentos/fcfm}
...
\def\nomltcontent {Índice de Contenidos}
