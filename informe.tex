...
\def\templateversion{3.8.5}               % Versión del template
...
\def\addemptypagetwosides{false} % Añade páginas en blanco al imprimir por ambas caras
