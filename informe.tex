...
\def\templateversion{3.4.7}               % Versión del template
\def\templateversion{3.4.8}               % Versión del template
...
\def\showdotontitle {false}           % Muestra un punto en cada título/subtítulo/etc.
