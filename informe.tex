...
\def\templateversion{3.1.7}               % Versión del template
...
% CONFIGURACIONES
\newcommand{\defaultimagefolder}{images/}
\newcommand{\defaultnewlinesize}{11pt}
\newcommand{\defaultinterlind}{1.0}
\newcommand{\tipofuentetitulo}{\huge}
\newcommand{\tipofuentesubtitulo}{\Large}
\newcommand{\tipofuentesubsubtitulo}{\large}
\newcommand{\tipofuentetituloi}{\huge}
\newcommand{\tipofuentesubtituloi}{\Large}
\newcommand{\tipofuentesubsubtituloi}{\large}
\newcommand{\etipofuentetitulo}{\bfseries}
\newcommand{\etipofuentesubtitulo}{\bfseries}
\newcommand{\etipofuentesubsubtitulo}{\bfseries}
\newcommand{\etipofuentetituloi}{\bfseries}
\newcommand{\etipofuentesubtituloi}{\bfseries}
\newcommand{\etipofuentesubsubtituloi}{\bfseries}
\newcommand{\tiporeferencias}{apa}
...
\newcommand{\indexdepth}{3}
\newcommand{\tablepadding}{1.1}
\newcommand{\defaultcaptionmargin}{2.9}
\newcommand{\defaultpagemarginleft}{2.5}
\newcommand{\defaultpagemarginright}{2.5}
\newcommand{\defaultpagemargintop}{3.0}
\newcommand{\defaultpagemarginbottom}{2.7}
\newcommand{\defaultfirstpagemargintop}{3.8}
\newcommand{\defaultmarginfloatimages}{-13pt}
\newcommand{\defaultmargintopimages}{0.0cm}
\newcommand{\defaultmarginbottomimages}{-0.2cm}
\newcommand{\defaultcaptionlessmargin}{0.1cm}
\newcommand{\defaultindextitlemargin}{7pt}
\newcommand{\nombrepaginaportada}{Portada}

% CONFIGURACIONES BOOLEANAS
\newcommand{\codigocursoenportada}{false}
\newcommand{\referenceassection}{false}
\newcommand{\showborderonlinks}{false}
\newcommand{\showfooter}{true}
\newcommand{\showheadertitle}{true}
\newcommand{\showindex}{true}
\newcommand{\showindexofcontents}{true}
\newcommand{\showindexoffigures}{true}
\newcommand{\showindexofsourcecode}{false}
\newcommand{\showindexoftables}{true}
\newcommand{\twocolumnreferences}{false}
