...
\def\templateversion{3.4.2}               % Versión del template
...
\def\showsectiononcaption {true}      % Muestra el número de sección en la leyenda
