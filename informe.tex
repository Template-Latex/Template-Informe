...
\def\templateversion{3.2.1}               % Versión del template
...
\def\etipofuentesubsubtitulo {\bfseries}
\def\etipofuentesubsubtituloi {\bfseries}
\def\etipofuentesubtitulo {\bfseries}
\def\etipofuentesubtituloi {\bfseries}
\def\etipofuentetitulo {\bfseries}
\def\etipofuentetituloi {\bfseries}
\def\indexdepth {3}
\def\nombrepaginaportada {Portada}
\def\nomltcontend {Índice de Contenidos}
\def\nomltfiguras {Lista de Figuras}
\def\nomltsrc {Lista de Códigos Fuente}
\def\nomlttablas {Lista de Tablas}
\def\nomltwcodfuente {Código Fuente}
\def\nomltwfigura {Figura}
\def\nomltwtablas {Tabla}
\def\tablepadding {1.1}
\def\tipofuentesubsubtitulo {\large}
\def\tipofuentesubsubtituloi {\large}
\def\tipofuentesubtitulo {\Large}
\def\tipofuentesubtituloi {\Large}
\def\tipofuentetitulo {\huge}
\def\tipofuentetituloi {\huge}
\def\tiporeferencias {apa}

% CONFIGURACIONES BOOLEANAS
\def\codigocursoenportada {false}
