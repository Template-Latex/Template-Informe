...
\def\templateversion{3.3.9}               % Versión del template
...
\def\defaultcaptionlessmargin {0.1cm}  % Margen sup/inf. de fig. si no hay leyenda
...
\def\showsectiononcaption {false}       % Muestra el número de sección en la leyenda
...
\def\pagemarginleft {2.5}              % Margen izquierdo página [cm]
\def\pagemarginright {2.5}             % Margen derecho página [cm]
