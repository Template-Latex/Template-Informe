...
\newcommand{\tipofuentesubsubtitulo}{\large}      % Tamaño de los subsubtítulos
...
\newcommand{\tipofuentesubsubtituloi}{\large}     % Tamaño de los subsubtítulos en el índice
...
\newcommand{\etipofuentesubsubtitulo}{\bfseries}  % Estilo de los subsubtítulos
...
\newcommand{\etipofuentesubsubtituloi}{\bfseries} % Estilo de los subsubtítulos en el índice
...
\newcommand{\nombrepaginaportada}{P}              % Nombre de la primera página (portada)
...
\usepackage{wasysym}                  % Contiene carácteres misceláneos
