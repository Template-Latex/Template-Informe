...
\def\templateversion{3.5.0}               % Versión del template
...
\def\showdotontitle {true}         % Punto al final de cada título/subtítulo/etc
