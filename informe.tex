...
\newcommand{\tipofuentesubsubtituloi}{\large}     % Tamaño sub-subtit. en el índice
...
\newcommand{\defaultmarginfloatimages}{-13pt}     % Margen sup. figura flotante [pt]
...
\hypersetup{
	...
	pdfproducer={Template LaTeX informe v2.4.0}}
