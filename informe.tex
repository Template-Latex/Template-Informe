...
\def\templateversion{3.5.8}               % Versión del template
...
% COLORES DEL DOCUMENTO [http://latexcolor.com/]
\def\citecolor {black}            % Color del número de las referencias o citas
\def\maintextcolor {blue}         % Color principal del texto
...
\ifthenelse{\equal{\showindex}{true}}{\newpage\sectionfont{\fontsizetitlei \styletitlei \selectfont}\subsectionfont{\fontsizesubtitlei \stylesubtitlei \selectfont}\subsubsectionfont{\fontsizesubsubtitlei \stylesubsubtitlei \selectfont}\ifthenelse{\equal{\showindexofcontents}{true}}{\tableofcontents}{}\ifthenelse{\equal{\showindexoffigures}{true}}{\listoffigures}{}\ifthenelse{\equal{\showindexoftables}{true}}{\listoftables}{}\ifthenelse{\equal{\showindexofcode}{true}}{\lstlistoflistings}{}}{}

% CONFIGURACIONES FINALES
\newpage\ifthenelse{\equal{\showheadertitle}{true}}{\fancyhead[L]{\nouppercase{\leftmark}}}{}\sectionfont{\color{red} \fontsizetitle \styletitle \selectfont}\subsectionfont{\fontsizesubtitle \stylesubtitle \selectfont}\subsubsectionfont{\fontsizesubsubtitle \stylesubsubtitle \selectfont}\renewcommand{\thepage}{\arabic{page}}\setcounter{page}{1}\setcounter{section}{0}\setcounter{footnote}{0}
