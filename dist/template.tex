...
% Define cuál función se ejecuta al insertar páginas en blanco
\let\addemptypagespredocformat\insertblankpage
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={7.5.6-2},
		Template.Version.Hash={BEFB044689773A86170253B04BE6F2BD},
		Template.Version.Release={7.5.6},
	...
	pdfproducer={Template-Informe v7.5.6 | (Pablo Pizarro R.) ppizarror.com},
...
% -----------------------------------------------------------------------------
% Modifica comportamiento nuevas páginas en formato twosides
% -----------------------------------------------------------------------------
...
\newcommand{\templateIndex}{
	...
	% -------------------------------------------------------------------------
	\ifthenelse{\equal{\addemptypagespredoc}{true}}{%
		\coretriggeronpage{\addemptypagespredocformat}{}%
	}{}
