...
\makeatletter
	...
	\g@addto@macro\documenttopic\xspace
...
\ifthenelse{\equal{\documentsubtitle}{}}{
	...
	\makeatletter
		\g@addto@macro\documentsubtitle\xspace
	\makeatother
...
\ifthenelse{\equal{\usepdfmetadata}{true}}{
	...
	\def\pdfmetainfotopic {\documenttopic}
...
\hypersetup{
	...
	pdfinfo={
		...
		Document.Topic={\pdfmetainfotopic},
		...
		Template.Version.Dev={7.4.3},
		Template.Version.Hash={FC1041565095BF589601FCC404C234BC},
		Template.Version.Release={7.4.3},
	...
	pdfproducer={Template-Informe v7.4.3 | (Pablo Pizarro R.) ppizarror.com},
...
\newcommand{\templatePortrait}{
	...
	\ifthenelse{\equal{\portraitstyle}{style5}}{
		...
		\begin{center}
			...
			\vspace*{0.35cm}
			\Large{\noindent \textcolor{\portraittitlecolor}{\documenttopic}} ~ \\
			\vspace*{1cm}
	...
	\ifthenelse{\equal{\portraitstyle}{style6}}{
		...
		\begin{center}
			\vspace*{0.5cm}
			{\color{dkgray} \Large \textbf{\MakeUppercase{\documenttopic}}} ~ \\
	...
	\ifthenelse{\equal{\portraitstyle}{style7}}{
		...
		\begin{center}
			...
			{\large \textcolor{\portraittitlecolor}{\documenttopic} ~ \\}
		\end{center}
	...
	\ifthenelse{\equal{\portraitstyle}{style11}}{
		...
		\begin{center}
			...
			{\fontsize{13pt}{10pt} \selectfont \textcolor{\portraittitlecolor}{\scshape{\documenttopic}}}
		\end{center}
	...
	\ifthenelse{\equal{\portraitstyle}{style12}}{
		...
		\begin{center}
			...
			{\bf \Large \textcolor{\portraittitlecolor}{\documenttopic}}
		\end{center}
	...
	\ifthenelse{\equal{\portraitstyle}{style14}}{
		...
		{\bf \large \noindent \textcolor{\portraittitlecolor}{\textsf{\MakeUppercase{\documenttopic}}}} \\
		...
		\begingroup
			...
			\begin{tikzpicture}[remember picture,overlay]
				...
				\draw (current page.center) node [fill=\portraitbackgroundcolorB!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{
						...
						{\Large \textcolor{\portraittitlecolor}{\documenttopic}} \\ [25pt]
						{\huge \documentauthor}}};
			\end{tikzpicture}
			\vfill
		\endgroup
	...
	\ifthenelse{\equal{\portraitstyle}{style20}}{
		...
		\parbox[b]{0.75\linewidth}{
			...
			{\large\textit{\textcolor{\portraittitlecolor}{\documenttopic}}}\\[4\baselineskip]
			\vspace*{2cm}
			{\textsc{
			\begin{flushleft}
	...
	\ifthenelse{\equal{\portraitstyle}{\bgtemplatetestcode}}{
		...
		\begin{center}
			...
			{\fontsize{15pt}{10pt} \selectfont \textcolor{\portraittitlecolor}{\scshape{\documenttopic}}}
		\end{center}
		\vfill
		\begin{flushright}
			\noindent \authortable
