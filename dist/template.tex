...
\global\def\GLOBALenvanexo {false}              % Indica que el entorno anexo está activo
...
\newcommand{\checkoutsideanexo}{%
	\ifthenelse{\equal{\GLOBALenvanexo}{true}}{%
...
\newenvironment{anexo}{
	\global\def\GLOBALenvanexo {true}%
...
\ifthenelse{\equal{\subtitulodocumento}{}}{
	\def\titulodeldocumentohf {\titulodeldocumento}
}{
	\makeatletter
		\g@addto@macro\subtitulodocumento\xspace
	\makeatother
	\def\titulodeldocumentohf {\subtitulodocumento}
}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={7.4.2-1},
		Template.Version.Hash={DEBB43E33A492827D4514C9FA56459ED},
		Template.Version.Release={7.4.2},
	...
	pdfproducer={Template-Informe v7.4.2 | (Pablo Pizarro R.) ppizarror.com},
...
\newcommand{\templatePortrait}{
	...
	\ifthenelse{\equal{\portraitstyle}{style1}}{
		...
		\begin{center}
			\textcolor{\portraittitlecolor}{
				{\noindent \Huge{\titulodeldocumento} \vspace{0.5cm}} ~ \\
	...
	\ifthenelse{\equal{\portraitstyle}{style2}}{
		...
		\begin{center}
			...
			\vspace*{1.5cm}
			\textcolor{\portraittitlecolor}{
				{\centering \noindent \Huge{\titulodeldocumento} \vspace{0.3cm}} ~ \\
				{\noindent \large{\temaatratar}}
			}
		\end{center}
	...
	\ifthenelse{\equal{\portraitstyle}{style4}}{
		...
		\begin{center}
			{\fontsize{22pt}{10pt} \selectfont
				\noindent \textcolor{\portraittitlecolor}{\titulodeldocumento} \vspace*{0.35cm}} ~ \\
	...
	\ifthenelse{\equal{\portraitstyle}{style6}}{
		...
		\begin{center}
			...
			\Huge \textup \bfseries \textsc{\textcolor{\portraittitlecolor}{\titulodeldocumento}} ~ \\
			\noindent \rule{\linewidth}{0.3mm} ~ \\
		\end{center}
	...
	\ifthenelse{\equal{\portraitstyle}{style7}}{
		...
		\begin{center}
			...
			{\huge \textcolor{\portraittitlecolor}{\titulodeldocumento} \vspace{0.2cm} ~ \\}
	...
	\ifthenelse{\equal{\portraitstyle}{style10}}{
		...
		\begin{center}
			...
			\noindent \rule{\linewidth}{0.4mm} \\ \vspace{0.3cm}
			{\huge \bfseries \textcolor{\portraittitlecolor}{\titulodeldocumento} \vspace{0.2cm} \\}
	...
	\ifthenelse{\equal{\portraitstyle}{style11}}{
		...
		\vfill
		\begin{center}
			{\setstretch{1.2} \fontsize{21pt}{22pt} \selectfont \textcolor{\portraittitlecolor}{\scshape{\titulodeldocumento}} \vspace{0.5cm}} ~ \\
	...
	\ifthenelse{\equal{\portraitstyle}{style12}}{
		...
		\vfill
		\begin{center}
			{\bf \Huge \scshape{\textcolor{\portraittitlecolor}{\titulodeldocumento}} \vspace{0.3cm}} \\
		...
		\begin{center}
			\begin{minipage}{0.9\linewidth}
				\begin{framed}
					\LARGE
					\vspace{1cm}
					\centering \textcolor{\portraittitlecolor}{\textbf{\titulodeldocumento}}
					\vspace{1cm}
				\end{framed}
			\end{minipage}
		\end{center}
	...
	\ifthenelse{\equal{\portraitstyle}{style14}}{
		...
		% Título del informe
		\vfill
		{\bf \huge \noindent \textcolor{\portraittitlecolor}{\textsf{\MakeUppercase{\titulodeldocumento}} \vspace*{0.05cm}}} \\
	...
	\ifthenelse{\equal{\portraitstyle}{style15}}{
		...
		\vfill
		\begin{center}
			{\fontsize{25pt}{15pt} \selectfont \textcolor{\portraittitlecolor}{\textbf{\titulodeldocumento}} \vspace{0.7cm}} \\
			{\Large \textcolor{\portraittitlecolor}{\temaatratar}}
		\end{center}
		...
		\begingroup
			...
			\begin{tikzpicture}[remember picture,overlay]
				...
				\draw (current page.center) node [fill=\portraitbackgroundcolorB!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{
						\centering \textcolor{\portraittitlecolor}{\titulodeldocumento} \\ [10pt]
	...
	\ifthenelse{\equal{\portraitstyle}{style20}}{
		...
		\parbox[b]{0.75\linewidth}{
			{\Huge\bfseries \textcolor{\portraittitlecolor}{\titulodeldocumento}}\\[2\baselineskip]
	...
	\ifthenelse{\equal{\portraitstyle}{\bgtemplatetestcode}}{
		...
		\begin{center}
			\vspace*{-6cm}
			{\setstretch{1.2} \fontsize{25pt}{22pt} \selectfont \textcolor{\portraittitlecolor}{\scshape{\titulodeldocumento}} \vspace{0.5cm}} \\
			...
			\ifthenelse{\equal{\hfwidthwrap}{true}}{
				\fancyfoot[L]{
					\begin{minipage}[t]{\hfwidthtitle\linewidth}
						\begin{flushleft}
							\small \textit{\titulodeldocumentohf}
						\end{flushleft}
					\end{minipage}
				}
				\fancyfoot[R]{
